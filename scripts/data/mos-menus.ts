/**
 * モスバーガーメニューデータ（2026-02-12版 公式サイトスクレイピングより）
...
export const mosMenuData: MosMenuItem[] = [
  ...
  { menu_id: "mos-side-3", menu_name: "フレンチフライポテト", category: "サイドメニュー", price: 330, calories: 170, protein: 2.2, fat: 7, carb: 24.8, sodium: 0.5, allergens: ["大豆"] },
  { menu_id: "mos-side-4", menu_name: "オニポテ（フレンチフライポテト＆オニオンフライ）", category: "サイドメニュー", price: 330, calories: 189, protein: 2.6, fat: 8.7, carb: 25.3, sodium: 0.7, allergens: ["小麦", "大豆"] },
  { menu_id: "mos-side-5", menu_name: "チリディップソース", category: "サイドメニュー", price: 100, calories: 48, protein: 3, fat: 1.2, carb: 6.4, sodium: 1.1, allergens: ["小麦", "牛肉", "大豆", "鶏肉", "豚肉", "りんご"] },
  { menu_id: "mos-side-6", menu_name: "カップ ハラペーニョ", category: "サイドメニュー", price: 100, calories: 5, protein: 0.2, fat: 0.1, carb: 0.9, sodium: 0.4, allergens: [] },
  { menu_id: "mos-side-7", menu_name: "オニオンフライ", category: "サイドメニュー", price: 330, calories: 219, protein: 3.5, fat: 12.7, carb: 22.8, sodium: 1.1, allergens: ["小麦", "大豆"] },
  { menu_id: "mos-side-8", menu_name: "チキンナゲット（5コ入り）※ソース別売", category: "サイドメニュー", price: 360, calories: 195, protein: 14.8, fat: 10.2, carb: 10.9, sodium: 0.8, allergens: ["乳", "小麦", "さば", "大豆", "鶏肉"] },
  { menu_id: "mos-side-9", menu_name: "バーベキューソース", category: "サイドメニュー", price: 40, calories: 25, protein: 0.1, fat: 0, carb: 6, sodium: 0.7, allergens: ["大豆", "鶏肉", "りんご", "ゼラチン"] },
  { menu_id: "mos-side-10", menu_name: "マスタードソース", category: "サイドメニュー", price: 40, calories: 102, protein: 0.4, fat: 10.1, carb: 2.2, sodium: 0.7, allergens: ["卵", "大豆", "りんご"] },
  { menu_id: "mos-side-11", menu_name: "こだわりサラダ 和風ドレッシング＜減塩タイプ＞", category: "サイドメニュー", price: 330, calories: 41, protein: 1.3, fat: 1, carb: 7.3, sodium: 0.5, allergens: ["小麦", "ごま", "大豆", "鶏肉", "豚肉"] },
  { menu_id: "mos-side-12", menu_name: "和風ドレッシング＜減塩タイプ＞", category: "サイドメニュー", price: 30, calories: 22, protein: 0.3, fat: 1, carb: 3, sodium: 0.5, allergens: ["小麦", "ごま", "大豆", "鶏肉", "豚肉"] },
  { menu_id: "mos-side-13", menu_name: "モスチキンパック 5本入り", category: "サイドメニュー", price: 1500, calories: 1345, protein: 76.5, fat: 83, carb: 73.5, sodium: 7.5, allergens: ["小麦", "大豆", "鶏肉"] },
  { menu_id: "mos-side-14", menu_name: "バラエティパックA", category: "サイドメニュー", price: 1320, calories: 1256, protein: 17.4, fat: 58.8, carb: 164.4, sodium: 4.8, allergens: ["小麦", "大豆"] },
  { menu_id: "mos-side-15", menu_name: "バラエティパックB", category: "サイドメニュー", price: 1770, calories: 1427, protein: 43.5, fat: 66.5, carb: 163.4, sodium: 5.3, allergens: ["乳", "小麦", "さば", "大豆", "鶏肉"] },
  { menu_id: "mos-side-16", menu_name: "＜冷凍＞香る醤油のローストチキン 〜鹿児島県産 若鶏〜", category: "サイドメニュー", price: 650, calories: 208, protein: 20.3, fat: 12.9, carb: 2.6, sodium: 1.9, allergens: ["卵", "乳", "小麦", "大豆", "鶏肉"] },
  { menu_id: "mos-side-17", menu_name: "冷凍モスチキン 5本入り", category: "サイドメニュー", price: 1500, calories: 315, protein: 14.5, fat: 21.7, carb: 15.4, sodium: 1.5, allergens: ["小麦", "大豆", "鶏肉"] },
  ...
  { menu_id: "mos-drink-2", menu_name: "ぶどうとりんごのスパークリングサングリア＜ノンアルコール＞", category: "ドリンク/スープ", price: 360, calories: 116, protein: 0, fat: 0, carb: 29, sodium: 0.1, allergens: ["りんご"] },
  { menu_id: "mos-drink-3", menu_name: "まぜるシェイク いちご ～ とちあいか ～", category: "ドリンク/スープ", price: 350, calories: 237, protein: 2.7, fat: 5.3, carb: 44.4, sodium: 0.3, allergens: ["乳"] },
  { menu_id: "mos-drink-4", menu_name: "ブレンドコーヒー", category: "ドリンク/スープ", price: 300, calories: 5, protein: 0.2, fat: 0.2, carb: 1.3, sodium: 0, allergens: [] },
  { menu_id: "mos-drink-5", menu_name: "紅茶 キャンディ茶葉（レモン／ミルク）", category: "ドリンク/スープ", price: 300, calories: 2, protein: 0.2, fat: 0, carb: 0.2, sodium: 0, allergens: [] },
  { menu_id: "mos-drink-6", menu_name: "カフェラテ", category: "ドリンク/スープ", price: 360, calories: 66, protein: 3.6, fat: 4, carb: 5.4, sodium: 0.1, allergens: ["乳"] },
  { menu_id: "mos-drink-7", menu_name: "コーンスープ 北海道産コーン使用", category: "ドリンク/スープ", price: 380, calories: 140, protein: 3.6, fat: 7.2, carb: 15.3, sodium: 1.3, allergens: ["卵", "乳", "小麦", "大豆", "鶏肉"] },
  { menu_id: "mos-drink-8", menu_name: "クラムチャウダー", category: "ドリンク/スープ", price: 380, calories: 119, protein: 4.1, fat: 4.3, carb: 15.8, sodium: 1.3, allergens: ["卵", "乳", "小麦", "大豆", "鶏肉", "豚肉"] },
  { menu_id: "mos-drink-9", menu_name: "アイスコーヒー", category: "ドリンク/スープ", price: 330, calories: 10, protein: 0.4, fat: 0.2, carb: 2.1, sodium: 0, allergens: [] },
  { menu_id: "mos-drink-10", menu_name: "アイスティー キャンディ茶葉（レモン／ミルク）", category: "ドリンク/スープ", price: 330, calories: 2, protein: 0.2, fat: 0, carb: 0.2, sodium: 0, allergens: [] },
  { menu_id: "mos-drink-11", menu_name: "オレンジブレンド100", category: "ドリンク/スープ", price: 360, calories: 92, protein: 1, fat: 0, carb: 22.1, sodium: 0.2, allergens: ["オレンジ"] },
  { menu_id: "mos-drink-12", menu_name: "ペプシコーラ", category: "ドリンク/スープ", price: 270, calories: 87, protein: 0, fat: 0, carb: 21.7, sodium: 0, allergens: [] },
  { menu_id: "mos-drink-13", menu_name: "ジンジャーエール", category: "ドリンク/スープ", price: 270, calories: 74, protein: 0, fat: 0, carb: 18.6, sodium: 0, allergens: [] },
  { menu_id: "mos-drink-14", menu_name: "メロンソーダ（無果汁）", category: "ドリンク/スープ", price: 270, calories: 87, protein: 0, fat: 0, carb: 22, sodium: 0, allergens: [] },
  { menu_id: "mos-drink-15", menu_name: "アイスウーロン茶", category: "ドリンク/スープ", price: 270, calories: 2, protein: 0, fat: 0, carb: 0.3, sodium: 0, allergens: [] },
  { menu_id: "mos-drink-16", menu_name: "アイスカフェラテ", category: "ドリンク/スープ", price: 330, calories: 63, protein: 3.4, fat: 3.8, carb: 5.1, sodium: 0.1, allergens: ["乳"] },
  { menu_id: "mos-drink-17", menu_name: "モスシェイク バニラ", category: "ドリンク/スープ", price: 290, calories: 201, protein: 3, fat: 5.8, carb: 34.1, sodium: 0.4, allergens: ["乳"] },
  { menu_id: "mos-drink-18", menu_name: "モスシェイク コーヒー", category: "ドリンク/スープ", price: 290, calories: 183, protein: 2.8, fat: 5.2, carb: 31, sodium: 0.3, allergens: ["乳"] },
  { menu_id: "mos-drink-19", menu_name: "まぜるシェイク 出雲(いずも)の抹茶", category: "ドリンク/スープ", price: 350, calories: 218, protein: 3.5, fat: 5.5, carb: 38.6, sodium: 0.3, allergens: ["乳"] },
  { menu_id: "mos-drink-20", menu_name: "くだものと野菜（125ml紙パック）", category: "ドリンク/スープ", price: 100, calories: 52, protein: 0, fat: 0, carb: 13, sodium: 0.1, allergens: ["りんご"] },
