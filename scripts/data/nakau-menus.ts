...
export const nakauMenuData: NakauMenuItem[] = [
  ...
  // 【牛すき丼】
  { menu_id: "nakau-gyusuki-1", menu_name: "牛すき丼（並盛）", price: 640, category: "牛すき丼", calories: 630, protein: 15.7, fat: 17.2, carb: 105.7, sodium: 2900, allergens: [] },
  { menu_id: "nakau-gyusuki-2", menu_name: "とろたま牛すき丼（並盛）", price: 730, category: "牛すき丼", calories: 725, protein: 23.4, fat: 23.6, carb: 105.8, sodium: 3100, allergens: [] },
  { menu_id: "nakau-gyusuki-3", menu_name: "温たま牛すき丼（並盛）", price: 750, category: "牛すき丼", calories: 721, protein: 23.4, fat: 24.5, carb: 105.8, sodium: 3100, allergens: [] },
  ...
  { menu_id: "nakau-kaisen-2", menu_name: "まぐろユッケ丼（並盛）", price: 890, category: "海鮮丼", calories: 753, protein: 38.5, fat: 19.1, carb: 104.1, sodium: 3000, allergens: [] },
  ...
  // 【カツ丼】
  { menu_id: "nakau-katsu-1", menu_name: "カツ丼（並盛）", price: 640, category: "カツ丼", calories: 991, protein: 32.8, fat: 40.9, carb: 123.8, sodium: 3700, allergens: [] },
  { menu_id: "nakau-katsu-2", menu_name: "牛とじ丼（並盛）", price: 710, category: "カツ丼", calories: 795, protein: 27.4, fat: 26.2, carb: 113.1, sodium: 4700, allergens: [] },
  { menu_id: "nakau-katsu-3", menu_name: "チーズ牛とじ丼（並盛）", price: 870, category: "カツ丼", calories: 917, protein: 35.6, fat: 35.8, carb: 113.9, sodium: 5300, allergens: [] },
  { menu_id: "nakau-katsu-4", menu_name: "チーズカツ丼（並盛）", price: 800, category: "カツ丼", calories: 1113, protein: 41.0, fat: 50.6, carb: 124.7, sodium: 4300, allergens: [] },
  { menu_id: "nakau-katsu-5", menu_name: "牛あいがけカツ丼（並盛）", price: 970, category: "カツ丼", calories: 1169, protein: 39.3, fat: 52.6, carb: 134.0, sodium: 6300, allergens: [] },
  ...
  // 【鶏から丼】
  { menu_id: "nakau-torikara-1", menu_name: "鶏から丼（並盛）", price: 640, category: "鶏から丼", calories: 971, protein: 32.8, fat: 36.2, carb: 130.1, sodium: 4000, allergens: [] },
  { menu_id: "nakau-torikara-2", menu_name: "ねぎラー鶏から丼（並盛）", price: 800, category: "鶏から丼", calories: 1176, protein: 35.3, fat: 53.3, carb: 140.9, sodium: 4600, allergens: [] },
  { menu_id: "nakau-torikara-3", menu_name: "食べラー鶏から丼（並盛）", price: 730, category: "鶏から丼", calories: 1170, protein: 32.8, fat: 36.2, carb: 139.5, sodium: 4600, allergens: [] },
  { menu_id: "nakau-torikara-4", menu_name: "とろたま鶏から丼（並盛）", price: 730, category: "鶏から丼", calories: 1065, protein: 40.5, fat: 42.7, carb: 130.3, sodium: 4200, allergens: [] },
  { menu_id: "nakau-torikara-5", menu_name: "マヨ鶏から丼（並盛）", price: 690, category: "鶏から丼", calories: 1039, protein: 33.1, fat: 43.7, carb: 130.2, sodium: 4200, allergens: [] },
  ...
  { menu_id: "nakau-hiyaudon-3", menu_name: "冷やしはいからうどん（並）", price: 330, category: "冷うどん", calories: 359, protein: 8.8, fat: 6.9, carb: 68.0, sodium: 2700, allergens: [] },
  { menu_id: "nakau-hiyaudon-4", menu_name: "ざるうどん（並）", price: 430, category: "冷うどん", calories: 213, protein: 5.5, fat: 0.8, carb: 43.9, sodium: 600, allergens: [] },

  // 【温うどん】
  { menu_id: "nakau-udon-1", menu_name: "はいからうどん（並）", price: 330, category: "温うどん", calories: 322, protein: 7.2, fat: 6.4, carb: 59.0, sodium: 4600, allergens: [] },
  { menu_id: "nakau-udon-2", menu_name: "月見うどん（並）", price: 420, category: "温うどん", calories: 417, protein: 14.8, fat: 12.8, carb: 59.2, sodium: 4900, allergens: [] },
  { menu_id: "nakau-udon-3", menu_name: "きつねうどん（並）", price: 460, category: "温うどん", calories: 483, protein: 18.0, fat: 17.2, carb: 64.0, sodium: 5600, allergens: [] },
  { menu_id: "nakau-udon-4", menu_name: "和風カレーうどん（並）", price: 550, category: "温うどん", calories: 478, protein: 11.2, fat: 17.6, carb: 68.4, sodium: 4200, allergens: [] },
  ...
  { menu_id: "nakau-hiyasoba-3", menu_name: "冷やしはいからそば（並）", price: 450, category: "冷そば", calories: 367, protein: 11.1, fat: 7.2, carb: 64.5, sodium: 2100, allergens: [] },
  { menu_id: "nakau-hiyasoba-4", menu_name: "ざるそば（並）", price: 550, category: "冷そば", calories: 273, protein: 12.9, fat: 3.0, carb: 48.9, sodium: 0, allergens: [] },

  // 【温そば】
  { menu_id: "nakau-soba-1", menu_name: "はいからそば（並）", price: 450, category: "温そば", calories: 393, protein: 12.8, fat: 7.1, carb: 69.3, sodium: 6100, allergens: [] },
  { menu_id: "nakau-soba-2", menu_name: "月見そば（並）", price: 540, category: "温そば", calories: 488, protein: 20.5, fat: 13.5, carb: 69.5, sodium: 6400, allergens: [] },
  { menu_id: "nakau-soba-3", menu_name: "きつねそば（並）", price: 580, category: "温そば", calories: 440, protein: 18.0, fat: 9.7, carb: 69.9, sodium: 6600, allergens: [] },
  ...
  { menu_id: "nakau-okazu-5", menu_name: "ライス（並盛）", price: null, category: "おかず", calories: 380, protein: 6.6, fat: 1.3, carb: 89.9, sodium: 0, allergens: [] },
  ...
  { menu_id: "nakau-okazu-23", menu_name: "牛すき皿", price: 540, category: "おかず", calories: 250, protein: 9.0, fat: 15.8, carb: 15.7, sodium: 2900, allergens: [] },
  ...
  { menu_id: "nakau-okazu-25", menu_name: "カツとじ皿", price: 540, category: "おかず", calories: 611, protein: 26.2, fat: 39.5, carb: 33.9, sodium: 3700, allergens: [] },
  { menu_id: "nakau-okazu-26", menu_name: "牛とじ皿", price: 610, category: "おかず", calories: 415, protein: 20.8, fat: 24.8, carb: 23.1, sodium: 4700, allergens: [] },
  { menu_id: "nakau-okazu-27", menu_name: "うな皿（並盛）", price: null, category: "おかず", calories: 261, protein: 15.8, fat: 17.9, carb: 8.9, sodium: 1400, allergens: [] },
  ...
  { menu_id: "nakau-okazu-33", menu_name: "こだわり卵のプリン（カスタード）", price: null, category: "おかず", calories: 174, protein: 3.3, fat: 11.0, carb: 15.3, sodium: 100, allergens: [] },

  // 【お子様メニュー】
  { menu_id: "nakau-kids-1", menu_name: "お子様きつねうどん", price: null, category: "お子様メニュー", calories: 244, protein: 9.0, fat: 8.6, carb: 32.5, sodium: 3500, allergens: [] },
  ...
  { menu_id: "nakau-kids-3", menu_name: "お子様わかめうどん", price: null, category: "お子様メニュー", calories: 132, protein: 3.6, fat: 0.5, carb: 28.7, sodium: 3200, allergens: [] },
  ...
  { menu_id: "nakau-kids-5", menu_name: "お子様カレー丼ぶり", price: null, category: "お子様メニュー", calories: 319, protein: 6.4, fat: 5.4, carb: 64.4, sodium: 2000, allergens: [] },
  { menu_id: "nakau-kids-6", menu_name: "お子様親子丼ぶり", price: null, category: "お子様メニュー", calories: 500, protein: 28.3, fat: 17.1, carb: 59.7, sodium: 3500, allergens: [] },
  { menu_id: "nakau-kids-7", menu_name: "お子様きつねうどんセット", price: null, category: "お子様メニュー", calories: 512, protein: 12.5, fat: 20.0, carb: 70.7, sodium: 3600, allergens: [] },
  ...
  { menu_id: "nakau-kids-9", menu_name: "お子様わかめうどんセット", price: null, category: "お子様メニュー", calories: 400, protein: 7.1, fat: 11.9, carb: 66.8, sodium: 3400, allergens: [] },
  ...
  { menu_id: "nakau-kids-11", menu_name: "お子様カレー丼ぶりセット", price: null, category: "お子様メニュー", calories: 587, protein: 9.9, fat: 16.8, carb: 102.6, sodium: 2200, allergens: [] },
  { menu_id: "nakau-kids-12", menu_name: "お子様親子丼ぶりセット", price: null, category: "お子様メニュー", calories: 768, protein: 31.9, fat: 28.5, carb: 97.8, sodium: 3600, allergens: [] },
